...
const results = faveColorFinder('green')
console.log(results)
...
const thatsOdd = (number) =>{
  if (number % 2 === 0){
    return "That's not a odd!"
  } else {
    return "That is odd indeed"
  }
}

const nums = thatsOdd(65)
console.log(nums)
////////////////// PROBLEM 14 ////////////////////
...
const bestMovie = (movieTitle) => `${movieTitle} is the best move ever!`
...
//CODE HERE
const theEliminator = (contestant, loser) => {
...
const finalContestants = theEliminator(contestants, loser)
...
const emailCheck = (email) => {
  ...
  if (email.includes('@')){
    ...
    return 'Must prvide a vaild email address'
  }
}
...
const frogChocolatePurchase = (gold) => {
  return gold / 3
}

let chocolateFrogs = frogChocolatePurchase(100)
////////////////// PROBLEM 20 ////////////////////
/*
...
//CODE HERE
const frogChocolatePurchase2 = (gold) => {
  if (gold % 3 === 0) {
    return gold / 3
  } else if ((gold - 1) % 3 === 0) {
    return (gold - 1) / 3
...
const totalChocolateFrogs2 = frogChocolatePurchase2(100)
...
let bathtubScope = ['rubberDuck', 'duck', 'sailor']
